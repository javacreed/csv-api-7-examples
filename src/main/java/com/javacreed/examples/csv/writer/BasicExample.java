...
/**
 * Provides a very basic example of how to produce a CSV string. This example uses the default settings and prints the
 * output to the logs (and console).
 *
...
public class BasicExample {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    try (CsvWriter csv = new CsvWriter(writer)) {
      ...
      /* Creates a CSV with 4 columns and fill these. Note that the order in which */
      csv.headers("A", "B", "C", "D");
      for (int i = 0; i < 15; i++) {
